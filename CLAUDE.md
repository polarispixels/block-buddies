...
`game.advanceStage`), everything else single-stage. A stage's
...
- **Mini-games/sublevels**: levels with STRING ids in `LEVEL_META`/`buildLevel`
  ...
  'meadow2', 'water2', 'cloud2', 'mountain2', 'letterblocks', 'endingblocks', 'countblocks', 'flowerland', 'surf', 'space2'; since v1.20.0
...
- **`node test/harness.js`** — headless smoke test that stubs DOM/canvas/
  ...
  actual badge/footer values). 793 checks; must print
