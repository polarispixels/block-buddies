...
<script src="js/entities.js"></script><script src="js/puzzleblocks.js"></script><script src="js/ride.js"></script><script src="js/levels.js"></script><script src="js/game.js"></script>
